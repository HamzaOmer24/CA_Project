...
module RISC_V_processor(
    ...
    Mux_3_to_1 mm(idexreaddata1, writedata, exmemaluout, forwarda, m3to1out1);
    Mux_3_to_1 mn(idexreaddata2, writedata, exmemaluout, forwardb, m3to1out2);
    ...
    MEM_WB memwb(clk, reset, datamemoryreaddata, exmemaluout, exmemrd, exmemmemtoreg, exmemregwrite, memwbreaddataout, memwbaluout, memwbrd, memwbmemtoreg, memwbregwrite);
